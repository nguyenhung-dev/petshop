  ...
  <section class="main-shop">
    <div class="container">
      <div class="left">
        ...
        <h3><?php echo $categoryValue[0]['name']; ?></h3>
          ...
          <div class="product">
            <div class="img">
              ...
              <div class="add-cart">
                ...
                <a href="../../controllers/CartControllers.php?product_id=<?php echo $product['product_id']; ?>"><i
            ...
            <div class="name">
              <a href="detail.php?product_id=<?php echo $product['product_id']; ?>"><?php echo $product['name']; ?></a>
            </div>
            <div class="price">
