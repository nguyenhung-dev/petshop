      ...
      <div class="list-categories" style="margin-top: 15px;">
        <table>
          ...
          <tr>
            ...
            <td class="actions">
              <div class="btn">
                <a href="comment.php?product_id=<?php echo $product['product_id']; ?>"><i
                    class="fa-solid fa-comment"></i></a>
              </div>
              <div class="btn">
                <a
                  href="../../controllers/ProductControllers.php?submit=edit&product_id=<?php echo $product['product_id']; ?>"><i
                    class="fa-solid fa-pen-to-square"></i></a>
              </div>
              <div class="btn">
                <a href="#"
                  onclick="confirmDelete('<?php echo $product['product_id']; ?>', '<?php echo $product['name']; ?>')"><i
