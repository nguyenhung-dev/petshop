...
if (isset($_SESSION['create_category_success'])) {
    $messageSuccess = '<i class="fa-solid fa-check check"></i> Thêm danh mục mới thành công.';
        ...
        <div class="main">
            ...
            <div class="add-category">
                <form action="../../controllers/CategoryControllers.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="button">
                        <button type="submit" name="submit" value="add-category">Thêm mới</button>
                    </div>
                </form>
            </div>
        </div>
