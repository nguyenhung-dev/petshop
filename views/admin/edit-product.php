...
if (isset($_SESSION['edit_product_success'])) {
    $messageSuccess = '<i class="fa-solid fa-check check"></i> Cập nhật thành công.';
    unset($_SESSION['edit_product_success']);
}

if (isset($_SESSION['value_product_edit'])) {
    $product_value = $_SESSION['value_product_edit'];
    unset($_SESSION['value_product_edit']);
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="wrapper">
        ...
        <div class="add-category">
                ...
                <form action="../../controllers/ProductControllers.php" method="post" enctype="multipart/form-data">
                    ...
                    echo (isset($product_value['product_id'])) ? $product_value['product_id'] : ""; ?>" readonly>
                    <div class="error"></div>
                    ...
                    <div class="button">
                        <button type="submit" name="submit" value="edit-product">Chỉnh sửa</button>
                    </div>
                </form>
            </div>
        </div>
